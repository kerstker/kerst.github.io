...
url: "https://kerstker.github.io/kerst.github.io/" # the base hostname & protocol for your site
```

## User settings
```yml
username: Kerst_ker
user_description: NOPE
user_title: kerst_ker
email: kerstsama@gmail.com
```
...
```html
<a aria-label="My Github" target="_blank" href="https://kerstker.github.io/kerst.github.io/">
